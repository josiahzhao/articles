...
docker docker buildx build -t josiahzhao/docker-hexo-next:1.0.0 -t josiahzhao/docker-hexo-next:latest . --platform linux/amd64


docker build -t josiahzhao/docker-hexo-next:1.0.0 -t josiahzhao/docker-hexo-next:latest .


docker run -d -p 3000:4000 josiahzhao/docker-hexo-next:1.0
...
docker cp ba9daf698201:/hexo/website/themes/next/source/css .




docker build -t josiahzhao/docker-hexo-next:0.5 .
docker build -t josiahzhao/docker-hexo-next:1.0 .
